    ...
    <body class='body'>
        ...
        <div class="main-area">
            <img src="http://localhost/nectarofservice/assets/images/memphis-twinkle-lights.png" id="twinkle-lights" style="position:absolute; top:-1%;right:20%; z-index:-1; filter:saturate(200%); width:24rem; transform: translate(0,-1.4rem) rotate(-6deg);">
