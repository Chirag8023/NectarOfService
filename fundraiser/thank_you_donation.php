...
<div class="container">
            ...
            <p>Thank you for your contribution to the <?php echo $_SESSION['chi_campaign_name']; ?> campaign. Your support is greatly appreciated.<br><br>
            Sincerely,<br>
            Nectar of Service Team</p>
            
            <br>
            <div>
            <a href='http://localhost/NectarOfService/assets/scripts/generate_receipt.php'><button class="header-button">Download Receipt</button></a>
            <br><br>
