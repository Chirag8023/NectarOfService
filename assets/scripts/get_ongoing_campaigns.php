    ...
    <div class="fundraiser-donation-data" style="display: flex;">
        <?php if (file_exists($campaign['image_path'])): ?>
            <div class="image-container" style="flex: 30%; height:19rem;">
                <img src="<?php echo $campaign['image_path']; ?>" style="object-fit: cover;width:100%;height:100% !important; border-top-left-radius: 1px; border-bottom-left-radius: 1px; margin-left:-1rem;border-right:2px solid black;" alt="Campaign Image">
            </div>
        <?php endif; ?>
        <div class="right-side-content-wrapper" style="flex: 70%; padding-right:0.2rem;">
            ...
            <?php else: ?>
                <a href="http://localhost/nectarofservice/fundraiser/donate.php?campaign_id=<?php echo $campaign['id']; ?>"><button class="header-button" style="margin: 0.8rem 0 0.8rem 0;">Donate</button></a>
            <?php endif; ?>
        </div>
    </div>
<?php endforeach; ?>
